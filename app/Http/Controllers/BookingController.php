...
//        Booking::withTrashed()->get()->dd();
    ...
    public function create()
    {
        ...
        return view('bookings.create')->with('users',$users)->with('rooms',$rooms)->with('booking',(new Booking));
    }
...
//        dd($booking);
        ...
        return view('bookings.edit')
            ...
            ->with('bookingsUsers',$bookingsUser);
    }
    ...
    public function update(Request $request, Booking $booking)
    {
        ...
        $booking->save();
//        DB::table('bookings_users')->where('booking_id',  $booking->id)->update([
//            'user_id' => $request->input('user_id'),
//        ]);
